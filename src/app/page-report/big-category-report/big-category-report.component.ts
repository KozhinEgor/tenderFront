...
@Component({
  selector: 'app-big-category-report',
  templateUrl: './big-category-report.component.html',
  styleUrls: ['./big-category-report.component.scss']
})
export class BigCategoryReportComponent implements OnInit {
  ...
  loadReport(){
    ...
    this.api.getReportQuarterBigCategory(this.tabs[this.selected.value].big_category_id, this.receivedJson).subscribe(posts => {
    ...
    this.api.getReportVendorQuarterBigCategory(this.tabs[this.selected.value].big_category_id, this.receivedJson).subscribe(posts => {
    ...
    this.api.getReportNoVendorQuarterBigCategory(this.tabs[this.selected.value].big_category_id, this.receivedJson).subscribe(posts => {
